      ...
      <ScrollView>
        <Container>
          ...
          <Image source={logo} resizeMode='stretch'/>
            <ContainerInputs>
              <Input isError={undefined} iconLeft iconNames={'user'} iconSize={20} placeholder='Digite seu nome'/>
              <Input isError={undefined} iconLeft iconNames={'mail'} iconSize={20} placeholder='Digite seu email'/>
              <Input isError={undefined} iconLeft iconNames={'lock'} iconSize={20} placeholder='Digite sua senha' iconViewPassword secureTextEntry/>
              <Input isError={undefined} iconLeft iconNames={'lock'} iconSize={20} placeholder='Confirme sua senha' iconViewPassword secureTextEntry/>
            </ContainerInputs>
